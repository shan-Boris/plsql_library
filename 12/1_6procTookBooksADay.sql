-- Создай процедуру, возвращающую таблицу выданных книг за определенный день.

CREATE OR REPLACE PROCEDURE TOOK_BOOKS_A_DAY (
...
BEGIN
    ...
    DBMS_OUTPUT.put_line ('Выданные книги за ' || DAY$);
